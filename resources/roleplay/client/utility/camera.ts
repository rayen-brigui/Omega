...
export function createPedEditCamera(offset = null){
    ...
    if (!camera) {
        ...
        const forwardCameraPosition= { x: startPosition.x + forwardVector.x * 1.2, y: startPosition.y + forwardVector.y * 1.2, z: startPosition.z + zpos };
        fov = 90;
...
export function setShouldDisableControls(status) {
