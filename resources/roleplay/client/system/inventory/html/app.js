...
const app = new Vue({
    ...
    data() {
        return {
            ...
            splitAmount: 1,
            locales: {
                ITEM_SLOTS: ['Hat', 'Mask', 'Top', 'Pants', 'Shoes', 'Glasses', 'Ears', 'Bag', 'Armor', 'Watch', 'Chain'],
                LABEL_SPLIT: 'Split',
                LABEL_CANCEL: 'Abort'
            }
        };
    ...
    mounted() {
        ...
        this.inventory = { maxWeight: 150.0, items: new Array(50).fill(null), money: 0.0 };
