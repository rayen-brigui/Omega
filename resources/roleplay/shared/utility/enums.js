...
export const VehicleLock_States =[VehicleLock_State.UNLOCKED, VehicleLock_State.LOCKED];

export var VehicleSeatList ={
    DRIVER : -1,
    PASSENGER : 0,
    DRIVER_REAR : 1,
    PASSENGER_REAR : 2
